...
const Hero = () => {
  return (
    ...
    <section className="text-gray-800 body-font bg-[#ecf4fb] flex items-center w-full h-screen py-16 font-serif">
...
<ReactTyped
  ...
  typeSpeed={50}   // Adjust the typing speed as desired
  backSpeed={30}   // Adjust the backspacing speed as desired
  loop             // This will make the animation loop indefinitely
  wrapper="p"      // This specifies that the text will be wrapped in a <p> tag
